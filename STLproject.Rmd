...
The models fits are comparable. While the capped implicit model has the best fit, the attribution model is about equally good (p=0.88). Which means we can't really draw any conclusions from this analysis.
